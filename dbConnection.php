...
$host = '194.81.104.22';    //The Hostname/IP Address of the database server.
...
$username = 'group5_1920';  //The username of user that can access the database.
$password = 'gp';           //The user's password.
